        ...
        <section className="px-4 md:px-16 pt-20 md:pt-32 pb-24 md:pb-32 border-b-8 border-black relative z-10 w-full overflow-hidden bg-white selection:bg-black selection:text-[#00ff41]">
            ...
            <div className="relative">
                ...
                <motion.h1
                    ...
                    className="text-6xl xs:text-7xl md:text-[12rem] font-black tracking-[calc(-0.06em)] leading-[0.85] uppercase mb-8"
                >
                    VYTRONIX <br />
                    <span className="text-stroke-4 text-white">{t.hero_systems}</span>
                </motion.h1>
